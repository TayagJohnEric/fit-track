<!-- Mobile Sidebar -->
<div id="sidebar" class="sidebar-transition sidebar-mobile-closed md:sidebar-mobile-open fixed md:static top-0 left-0 z-50 w-64 h-full bg-gray-100 text-gray-700">
    <!-- Sidebar Header -->
    ...
    <li class="px-3 py-2 text-xs font-semibold text-gray-400 uppercase">Admin Dashboard</li>
            <!-- Dashboard -->
            <li>
                <a href="{{ route('admin.dashboard') }}" class="group flex items-center font-semibold p-3 rounded-lg hover:bg-gray-800 hover:text-white transition-all duration-200">
    ...
    <li class="px-3 py-2 text-xs font-semibold text-gray-400 uppercase">Content Management</li> 
            ...
            <li>
                <a href="/fitness-motivations" class="group flex items-center font-semibold p-3 rounded-lg hover:bg-gray-800 hover:text-white transition-all duration-200">
                    ...
                    <span class="ml-3 text-sm">Fitness Motivations</span>
                </a>
            </li>
