@extends('layout.user')
@section('title', 'Edit Custom Food Item')
@section('content')
<div class="max-w-[90rem] mx-auto">
    ...
    <div class=" p-6">
        ...
        <div class="flex items-center justify-between mt-4 mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Edit Custom Food Item</h2>
            <div class="flex space-x-3">
            </div>
        </div>

        <form method="POST" action="{{ route('custom-foods.update', $custom_food) }}" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" 
                           name="name" 
                           value="{{ old('name', $custom_food->name) }}"
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('serving_size_description', $custom_food->serving_size_description) }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('serving_size_grams', $custom_food->serving_size_grams) }}"
                           min="1"
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('calories_per_serving', $custom_food->calories_per_serving) }}"
                           min="0"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('protein_grams_per_serving', $custom_food->protein_grams_per_serving) }}"
                           min="0"
                           step="0.1"
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('carb_grams_per_serving', $custom_food->carb_grams_per_serving) }}"
                           min="0"
                           step="0.1"
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('fat_grams_per_serving', $custom_food->fat_grams_per_serving) }}"
                           min="0"
                           step="0.1"
            ...
            <div>
                ...
                @if($custom_food->image_url)
                    <div class="mb-4">
                        <p class="text-sm text-gray-600 mb-2">Current Image:</p>
                        <img src="{{ asset('storage/' .  $custom_food->image_url) }}" alt="{{ $custom_food->name }}" class="max-w-xs h-32 object-cover rounded-lg border border-gray-300">
                        <div class="mt-2">
                    ...
                    <div class="space-y-1 text-center">
                        ...
                        <div class="flex text-sm text-gray-600">
                            <label for="image_url" class="relative cursor-pointer bg-white rounded-md font-medium text-orange-600 hover:text-orange-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-orange-500">
                                <span>{{ $custom_food->image_url ? 'Replace image' : 'Upload a file' }}</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" 
                           name="estimated_cost" 
                           value="{{ old('estimated_cost', $custom_food->estimated_cost) }}"
                           min="0"
                           step="0.01"
                    ...
                    @foreach($allergies as $allergy)
                        <label class="flex items-center space-x-2">
                            <input type="checkbox" 
                                   name="allergies[]" 
                                   value="{{ $allergy->id }}"
                                   {{ in_array($allergy->id, old('allergies', $custom_food->allergies->pluck('id')->toArray())) ? 'checked' : '' }}
            ...
            <div class="bg-gray-50 rounded-lg p-4">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    <div>
                        ...
                        <span id="summary-calories" class="font-medium ml-2">{{ $custom_food->calories_per_serving }}</span>
                    </div>
                    <div>
                        <span class="text-gray-600">Protein:</span>
                        <span id="summary-protein" class="font-medium ml-2">{{ $custom_food->protein_grams_per_serving }}g</span>
                    </div>
                    <div>
                        <span class="text-gray-600">Carbs:</span>
                        <span id="summary-carbs" class="font-medium ml-2">{{ $custom_food->carb_grams_per_serving }}g</span>
                    </div>
                    <div>
                        <span class="text-gray-600">Fat:</span>
                        <span id="summary-fat" class="font-medium ml-2">{{ $custom_food->fat_grams_per_serving }}g</span>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-end space-x-4">
                <a href="{{ route('custom-foods.index') }}" 
                   class="inline-flex items-center px-4 py-2 bg-gray-100 border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-200 transition-all duration-200">
                    Cancel
                </a>
                <button type="submit"
                        class="inline-flex items-center px-4 py-2 bg-orange-600 border border-orange-500 text-white text-sm font-medium rounded-lg hover:bg-orange-700 hover:border-orange-600 transition-all duration-200 shadow-sm">
                        Update Custom Food
                    </button>
            </div>
        </form>
