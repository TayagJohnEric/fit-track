        ...
        <form method="POST" action="{{ route('exercises.update', $exercise->id) }}">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="4"
                          class="w-full px-4 py-2 border rounded">{{ old('description', $exercise->description) }}</textarea>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="equipment_needed" value="{{ old('equipment_needed', $exercise->equipment_needed) }}"
                       class="w-full px-4 py-2 border rounded">
