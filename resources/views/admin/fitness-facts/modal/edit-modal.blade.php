    ...
    <div class="modal-content bg-white rounded-lg p-6 max-w-4xl w-full">
        ...
        <form method="POST" action="{{ route('fitness-facts.update', $fact->id) }}">
            ...
            <div class="mb-4">
                ...
                <textarea 
                    name="fact_text" 
                    class="w-full p-2 border rounded focus:border-orange-600 focus:ring focus:ring-orange-200" 
                    required>{{ old('fact_text', $fact->fact_text) }}</textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <input 
                    type="text" 
                    name="category" 
                    value="{{ old('category', $fact->category) }}" 
                    class="w-full p-2 border rounded focus:border-orange-600 focus:ring focus:ring-orange-200">
            </div>
            ...
            <div class="flex items-center gap-4">
                ...
                <button type="button" onclick="closeEditModal({{  $fact->id }})" class="text-gray-600 hover:underline">
                    Cancel
                </button>
            </div>
        </form>
