    ...
    <div class="modal-content bg-white rounded-lg p-6 max-w-4xl w-full relative">
        ...
        <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $user->name) }}" 
                           class="w-full border rounded p-2 focus:border-orange-600 focus:ring focus:ring-orange-200" required>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="first_name" value="{{ old('first_name', $user->userProfile->first_name ?? '') }}" 
                           class="w-full border rounded p-2 focus:border-orange-600 focus:ring focus:ring-orange-200" required>
                </div>
                <div>
                    <label class="block text-gray-700">Last Name</label>
                    <input type="text" name="last_name" value="{{ old('last_name', $user->userProfile->last_name ?? '') }}" 
                           class="w-full border rounded p-2 focus:border-orange-600 focus:ring focus:ring-orange-200" required>
                </div>

                <div>
                    <label class="block text-gray-700">Date of Birth</label>
                    <input type="date" name="date_of_birth" value="{{ old('date_of_birth', $user->userProfile->date_of_birth ?? '') }}" 
                           class="w-full border rounded p-2 focus:border-orange-600 focus:ring focus:ring-orange-200" required>
                </div>
                <div>
                    <label class="block text-gray-700">Sex</label>
                    <select name="sex" class="w-full border rounded p-2 focus:border-orange-600 focus:ring focus:ring-orange-200" required>
                ...
                <div>
                    ...
                    <input type="number" step="0.1" name="height_cm" value="{{ old('height_cm', $user->userProfile->height_cm ?? '') }}" 
                           class="w-full border rounded p-2 focus:border-orange-600 focus:ring focus:ring-orange-200" required>
                </div>
                <div>
                    <label class="block text-gray-700">Weight (kg)</label>
                    <input type="number" step="0.1" name="current_weight_kg" value="{{ old('current_weight_kg', $user->userProfile->current_weight_kg ?? '') }}" 
                           class="w-full border rounded p-2 focus:border-orange-600 focus:ring focus:ring-orange-200" required>
                </div>

                <div>
                    <label class="block text-gray-700">Daily Budget (optional)</label>
                    <input type="number" step="0.01" name="daily_budget" value="{{ old('daily_budget', $user->userProfile->daily_budget ?? '') }}" 
                           class="w-full border rounded p-2 focus:border-orange-600 focus:ring focus:ring-orange-200">
                </div>

                <div>
                    <label class="block text-gray-700">Fitness Goal</label>
                    <select name="fitness_goal_id" class="w-full border rounded p-2 focus:border-orange-600 focus:ring focus:ring-orange-200" required>
                ...
                <div>
                    ...
                    <select name="experience_level_id" class="w-full border rounded p-2 focus:border-orange-600 focus:ring focus:ring-orange-200" required>
                ...
                <div>
                    ...
                    <select name="preferred_workout_type_id" class="w-full border rounded p-2 focus:border-orange-600 focus:ring focus:ring-orange-200" required>
            ...
            <div class="flex justify-end gap-4">
                ...
                <button type="button" onclick="closeEditModal({{ $user->id }})" class="text-gray-600 hover:underline">
                    Cancel
                </button>
            </div>
        </form>
