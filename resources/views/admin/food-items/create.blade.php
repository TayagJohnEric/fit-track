...
<div class="max-w-[90rem] mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <form method="POST" action="{{ route('food_items.store') }}">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="serving_size_description" value="{{ old('serving_size_description') }}"
                ...
                <div>
                    ...
                    <input type="number" name="serving_size_grams" value="{{ old('serving_size_grams') }}"
                           class="w-full border rounded px-4 py-2">
                ...
                <div>
                    ...
                    <input type="number" step="0.1" name="protein_grams_per_serving" value="{{ old('protein_grams_per_serving') }}"
                           class="w-full border rounded px-4 py-2">
                ...
                <div>
                    ...
                    <input type="number" step="0.1" name="carb_grams_per_serving" value="{{ old('carb_grams_per_serving') }}"
                           class="w-full border rounded px-4 py-2">
                ...
                <div>
                    ...
                    <input type="number" step="0.1" name="fat_grams_per_serving" value="{{ old('fat_grams_per_serving') }}"
                           class="w-full border rounded px-4 py-2">
