    ...
    <div class="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center mb-3">
                ...
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Food Items</h1>
            </div>
            <p class="text-gray-600 text-sm sm:text-base ml-6">Manage your nutrition database and food inventory</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <!-- Search Form -->
                <form method="GET" action="{{ route('food_items.index') }}" class="flex-1 max-w-md">
                ...
                <button onclick="openCreateModal()" 
                    ...
                    <span class="hidden sm:inline">Add New Food Item</span>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150 border-b border-gray-100 last:border-b-0">
                                    ...
                                    <td class="px-6 py-5">
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 border border-green-200">
                                            {{ $item->protein_grams_per_serving }}g
                                        </span>
                                    </td>
                    ...
                    <div class="food-card bg-white rounded-2xl shadow-sm p-5">
                        <div class="flex items-start justify-between mb-4">
                            ...
                            <div class="flex items-center flex-1 min-w-0">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-sm font-medium text-gray-600 mt-1">₱{{ number_format($item->estimated_cost, 2) }}</p>
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                            <div class="nutrition-badge bg-blue-50 border border-blue-200 rounded-lg p-3 text-center">
                                ...
                                <div class="text-sm font-bold text-blue-800">{{ $item->calories_per_serving }}</div>
                            </div>
                            <div class="nutrition-badge bg-green-50 border border-green-200 rounded-lg p-3 text-center">
                                ...
                                <div class="text-sm font-bold text-green-800">{{ $item->protein_grams_per_serving }}g</div>
                            </div>
                            <div class="nutrition-badge bg-yellow-50 border border-yellow-200 rounded-lg p-3 text-center">
                                ...
                                <div class="text-sm font-bold text-yellow-800">{{ $item->carb_grams_per_serving }}g</div>
                            </div>
                            <div class="nutrition-badge bg-red-50 border border-red-200 rounded-lg p-3 text-center">
                                ...
                                <div class="text-sm font-bold text-red-800">{{ $item->fat_grams_per_serving }}g</div>
                            </div>
                        </div>
                    </div>
                    @include('admin.food-items.modal.edit-modal', ['item'=> $item])
                ...
                <div class="flex flex-col items-center text-center">
                    <div class="w-20 h-20 bg-gradient-to-br from-orange-100 to-orange-200 rounded-2xl flex items-center justify-center mb-6">
                        <svg class="w-10 h-10 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.5 5M7 13l2.5 5m8.5-5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z"></path>
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">No food items found</h3>
                    <p class="text-gray-600 mb-6 max-w-md">Start building your nutrition database by adding your first food item.</p>
                    <button onclick="openCreateModal()" 
